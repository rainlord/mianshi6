...
if("TRUE" STREQUAL "TRUE")
  set(lidar_localization_SOURCE_PREFIX /home/rainlord/02_answer/src/lidar_localization)
  set(lidar_localization_DEVEL_PREFIX /home/rainlord/02_answer/devel)
  ...
  set(lidar_localization_INSTALL_PREFIX /home/rainlord/02_answer/install)
...
if(NOT "/home/rainlord/02_answer/devel/include " STREQUAL " ")
  set(lidar_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/rainlord/02_answer/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rainlord/02_answer/src/lidar_localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rainlord/02_answer/devel/lib;/home/rainlord/catkin_ws/devel/lib;/opt/ros/melodic/lib)
